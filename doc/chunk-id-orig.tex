...
\begin{figure}
	...
	\begin{multicols}{2}
		\begin{description}
			...
			\item [\textcolor{gray62}{e}] Listen to queues \texttt{C1, C2}
			...
			\item [\textcolor{gray62}{p}] Listen to queues \texttt{C1, C2, C3}
