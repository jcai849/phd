...
% \item \%do\% captures and creates environments, enabling sequential
%   evaluation, with dopar also doing work on capturing references to
%   variables in expressions and adding them to evaluation environment.
