...
Type safety is added through additional child manipulation methods, though this is exists in tension with the aim of a uniform interface - whether the child manipulation methods exist in the \hsrc{compositeChunk} class or the abstract \hsrc{chunk} class determines the balance of favour.
