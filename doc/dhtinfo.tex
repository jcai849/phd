...
Skipgraph is a distributed version of the skiplist probabilistic data structure, with simple operations and impressive access costs; the skiplist algorithm is made use of by Redis in it's implementation of ordered sets. % https://github.com/redis/redis/blob/unstable/src/t_zset.c
