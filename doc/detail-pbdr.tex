...
\lstinputlisting[float, language=R, frame=L, 
caption={Local GLM with RWLS},
label=src:local-rwls]{../R/local-rwls.R}
...
label=src:dmat]{../R/naive-pbdr-rwls.R}

\lstinputlisting[float, language=diff, frame=L, 
caption={Diff between local and pbdR code},
label=src:diff]{../R/local-rwls-to-pbdr.diff}
