...
\lstinputlisting[language=R,float,
	caption={Message queue master node, from original source at \lstname},
	label=src:msg-q-master]{../R/simple-msg-q-master.R}

\lstinputlisting[language=R,float,
	caption={Message queue worker node, from original source at \lstname},
	label=src:msg-q-worker]{../R/simple-msg-q-worker.R}
