...
\lstinputlisting[language=R, float,
	caption={Value return to request for client Node, from original source at \lstname},
	label=src:vr-client]{../R/val-return-msg-q-master.R}

\lstinputlisting[language=R, float,
	caption={Value return to request for server Node, from original source at \lstname},
	label=src:vr-server]{../R/val-return-msg-q-worker.R}

\lstinputlisting[language=R, float,
	caption={Demonstration of assignment in client Node, with
	client-Originated chunk name, from original source at \lstname},
	label=src:ro-ass-client]{../R/msg-q-assign-m-orig/master.R}

\lstinputlisting[language=R, float,
	caption={Demonstration of assignment in server Node, with
	client-Originated chunk name, from original source at \lstname},
	label=src:ro-ass-server]{../R/msg-q-assign-m-orig/worker.R}

\lstinputlisting[language=R, float,
	caption={Demonstration of assignment in client Node, with
	server-Originated chunk name, from original source at \lstname},
	label=src:wo-ass-client]{../R/msg-q-assign-w-orig/master.R}

\lstinputlisting[language=R, float,
	caption={Demonstration of assignment in server Node, with
	server-Originated chunk name, from original source at \lstname},
	label=src:wo-ass-server]{../R/msg-q-assign-w-orig/worker.R}
